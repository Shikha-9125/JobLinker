...
//         try {
//             const res = await axios.get("https://job-linker-xoes.onrender.com/api/v1/application/apply/${jobId}", {withCredentials:true});
                ...
                <>
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="font-bold text-xl">{singleJob?.title}</h1>
                            <div className="flex items-center gap-2 mt-4">
                                <Badge className={'text-blue-700 font-bold'} variant="ghost">{singleJob?.postion || "Not specified"} Positions</Badge>
                                <Badge className={'text-[#F83002] font-bold'} variant="ghost">{singleJob?.jobType || "Not specified"}</Badge>
                                <Badge className={'text-[#7209b7] font-bold'} variant="ghost">{singleJob?.salary || "Not specified"} LPA</Badge>
                            </div>
                        </div>
                        <Button
                            onClick={isApplied ? null : applyJobHandler}
                    ...
                    <div className="my-4">
                        ...
                        <h1 className="font-bold my-1">Location: <span className="pl-4 font-normal text-gray-800">{singleJob?.location || "Not specified"}</span></h1>
                        ...
                        <h1 className="font-bold my-1">Salary: <span className="pl-4 font-normal text-gray-800">{singleJob?.salary || "Not specified"} LPA</span></h1>
                        <h1 className="font-bold my-1">Total Applicants: <span className="pl-4 font-normal text-gray-800">{singleJob?.applications?.length || 0}</span></h1>
                        <h1 className="font-bold my-1">Posted Date: <span className="pl-4 font-normal text-gray-800">{singleJob?.createdAt?.split("T")[0] || "Not available"}</span></h1>
                    </div>
                </>
            ) : (
                <div>Loading...</div> // Add a loading state or placeholder
            )}
        </div>
    );
};
