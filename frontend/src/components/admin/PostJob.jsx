...
const PostJob = () => {
    ...
    const submitHandler = async (e) => {
        ...
        if (!input.title || !input.description || !input.requirements || !input.salary || !input.location || !input.jobType || !input.experience || input.position <= 0) {
                    ...
                    <div className='grid grid-cols-2 gap-2'>
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                name="position"
                                value={input.position}
                                onChange={(e) => setInput({ ...input, position: parseInt(e.target.value) || 0 })}
                                className="focus-visible:ring-offset-0 focus-visible:ring-0 my-1"
                            />
                        </div>
                        {companies.length > 0 && (
